...
<html>
    ...
    <body onresize='resize()'  id='home' >
        ...
        <form id="regForm1" name="regForm1" action="./ordiniByClient.jsp" method="post" style='margin:0 auto;'> 
        	<h2><center>Ricerca fatture per cliente</center></h2>
        	...
        	<br><br><br>
        		<table>
        			...
        			<tr>
        				<td>
        					<input type="text" name="username" placeholder="inserisci username cliente..." >
        				</td>
        			</tr>
